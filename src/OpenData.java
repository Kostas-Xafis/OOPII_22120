...
* @param country The country initials (i.e. gr, it, de).*/ 
 public static void RetrieveData(String city, String country) throws  IOException {
	 ...
	 OpenWeatherMap weather_obj = mapper.readValue(new URL("http://api.openweathermap.org/data/2.5/weather?q="+city+","+country+"&APPID="+weather_api_key+""), OpenWeatherMap.class);
	 System.out.println(city+" temperature: " + (weather_obj.getMain()).getTemp() + "K");
