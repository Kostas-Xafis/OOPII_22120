...
import main.City;
import citySorters.ascGeoDist;

/**
 * {@code PerceptronYoungTraveller} contains functions for recommendations to younger travellers
 *@author Konstantinos Xafis it22120
 *@version 1.1
 *@since 22-10-2021*/
public class PerceptronYoungTraveller implements PerceptronTraveller{
    private double[] weightBias = new double[]{.4, .6, -.2, -.3, .2, -.1, .4, .5, -.3, -.6};
    ...
    */
    ...
    public ArrayList<City> sortRecommendations() {
        ...
        Collections.sort(this.recommendations, new ascGeoDist());
        return this.recommendations;
    }
}
